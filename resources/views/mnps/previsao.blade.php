...
<ul class="list-group noprint">
    @foreach($local as $loc)
        ...
        <li class="list-group-item">
            <b>Diruno: </b> {{ number_format($loc->DIURNO,2)}}
        </li>
        <li class="list-group-item">
            <b>Vespertino: </b> {{ number_format($loc->VESPERTINO,2)}}
        </li>
        <li class="list-group-item">
            <b>Noturno1: </b> {{ number_format($loc->NOTURNO1,2)}}
        </li>
        <li class="list-group-item">
            <b>Noturno2: </b> {{ number_format($loc->NOTURNO2,2)}}
        </li>
    @endforeach
</ul>
